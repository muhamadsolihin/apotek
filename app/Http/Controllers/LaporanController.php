...
class LaporanController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('laporan.index', compact('transaksiItems', 'searchTerm', 'startDate', 'endDate'));
    }
    ...
    public function exportToPdf(Request $request)
    {
        ...
        $pdf = PDF::loadView('laporan.pdf', compact('transaksiItems', 'startDate', 'endDate'));
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('laporan.index')->with('success', 'Item added successfully.');
    }
    ...
    public function edit($id)
    {
        ...
        return view('laporan.edit', compact('laporanItem'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('laporan.index')->with('success', 'Item updated successfully.');
    }
