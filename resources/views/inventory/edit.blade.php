    ...
    <div class="col-md-10 py-5 container">
        ...
        <form action="{{ route('inventory.update', $inventoryItem->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="dosis" name="dosis" value="{{ $inventoryItem->dosis }}" required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control" id="expired_Date" name="expired_Date"  value="{{ $inventoryItem->expired_date }}" required>
            </div>
